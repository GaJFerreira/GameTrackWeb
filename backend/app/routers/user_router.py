...
# Import necessário para pegar o usuário logado
...
# ============================================================
# REGISTRO DE USUÁRIO (usado internamente — o principal registro está no /auth/register)
# ============================================================
...
# ============================================================
# ATUALIZAR O STEAM ID DO USUÁRIO LOGADO
# ============================================================
...
async def update_steam_id(new_steam_id: str, current_user=Depends(get_current_user)):
    ...
    # 2. Atualiza no banco (função síncrona, NÃO usar await)
    updated_user = user_service.update_user(
        current_user["uid"],   # UID do Firebase
